 ...
 *
 */
class GTSAM_EXPORT ISAM2Custom : public BayesTree<ISAM2Clique> {
 protected:
 ...
 public:
  using This = ISAM2Custom;                       ///< This class
  ...
  explicit ISAM2Custom(const ISAM2Params& params);
  ...
  /** Compare equality */
  virtual bool equals(const ISAM2Custom& other, double tol = 1e-9) const;
...
/// traits
template <>
struct traits<ISAM2Custom> : public Testable<ISAM2Custom> {};
